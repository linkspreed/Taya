...
## One to One Chat or Private Messaging
 - Your users will love it because Grupo Chat Script allows them to chat one-on-one. When users can talk to one another, your product engagement is higher.

## Dark Mode & Light Mode
 - Mode Switcher allows you to change the color theme of Grupo from white to black or black to white. The darker tones are more relaxing for user’s eyes to take in, especially in low light, and don’t draw as much power as brighter colors.
...
## Deny direct access to user uploaded files
 - Grupo protects from executing user uploaded php files as well as prevent Google, other search engines and unwanted users from indexing and stealing user files.
...
## Boxed or Full Width Layout
 - There are 2 layout types available in Grupo, Boxed & Full Width Layout. You can switch between these layouts with Grupo Customizer.

## Character Limit
 - Admin can set a minimum or maximum length of text message that users can send.

## Grupo Cron Jobs
 - Grupo Cron Jobs allows you to create time-based tasks in Grupo Grupo core includes features such as auto delete messages, auto delete users, etc.
...
## Grupo Booster
 - Our Booster speed up your Grupo performance by using Cache, CSS, JavaScript, etc.
